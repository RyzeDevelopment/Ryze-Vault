...
local Library = {
	...
	Scheme = {
		...
		AccentColor = Color3.fromRGB(39, 38, 42),
...
function Library:MakeOutline(Frame: GuiObject, Corner: number?, ZIndex: number?)
	warn("Raven:MakeOutline is deprecated, please use Raven:AddOutline instead.")
...
function Library:CreateWindow(WindowInfo)
	...
	do
		...
		RightWrapper = New("Frame", {
			AnchorPoint = Vector2.new(1, 0.5),
			BackgroundTransparency = 1,
			Position = UDim2.new(1, -255, 0.5, 0),
			Size = UDim2.new(1, -494 - 57 - 1, 1, -16),
			Parent = TopBar,
		})
