...
do
    ...
    ThemeManager.Folder = "RavenLibSettings"
    ...
    ThemeManager.BuiltInThemes = {
        ["Default"] = {
            1,
            { FontColor = "ffffff", MainColor = "191919", AccentColor = "27262a", BackgroundColor = "0f0f0f", OutlineColor = "282828" },
        },
        ["BBot"] = {
            2,
...
getgenv().RavenThemeManager = ThemeManager
return ThemeManager
